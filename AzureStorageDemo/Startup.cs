...
namespace AzureStorageDemo
{
    ...
    //        {
    //            builder.AddBlobServiceClient(Configuration["ConnectionStrings:connStringAzure:blob"], preferMsi: true);
    //            builder.AddQueueServiceClient(Configuration["ConnectionStrings:connStringAzure:queue"], preferMsi: true);
    //        });
    //    }
